...
const { TAB_SERVICE_URL } = process.env;

const createTabItem = async (req: Request, res: Response) => {
  try {
    const payload = req.body ?? {};

    const response = await fetch(`${TAB_SERVICE_URL}/api/tab-items`, {
      method: "POST",
      headers: {
...
const getTabItemById = async (req: Request, res: Response) => {
  try {
    ...
    const response = await fetch(`${TAB_SERVICE_URL}/api/tab-items/${tabItemId}`);
    const jsonResponse = await response.json();
...
const getTabItemsByTabId = async (req: Request, res: Response) => {
  try {
    ...
    const response = await fetch(`${TAB_SERVICE_URL}/api/tab-items/${tabId}/items`);
    const jsonResponse = await response.json();
...
const updateTabItem = async (req: Request, res: Response) => {
  try {
    ...
    const response = await fetch(
      `${TAB_SERVICE_URL}/api/tab-items/${tabItemId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
